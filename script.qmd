...
-   If you are running this script in RStudio Desktop, you will need to first run the `install` code below, by deleting the four `#` signs and running the code chunk. It will take a few of minutes until all packages are installed.
