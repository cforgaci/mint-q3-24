...
::: callout-note
Note that point 4 below is specific to this dataset and that you can skip it if your data is in English. For the default dataset, the translated texts are already included in the dato folder in TXT format.
:::
...
<!--# TODO to be added at the end of Part 1 on web scraping -->

### Exercise 1. Visualising scraped data
