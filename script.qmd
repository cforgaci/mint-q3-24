...
-   Then run this code to load the packages. If you are running this script in RStudio Desktop, make sure you add a `#` sign in front of `renv::deactivate()` before running the code chunk.
