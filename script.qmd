---
title: "Mining the Dutch news about farming communities"
...
2.  Open RStudio and create a new project from `File > New Project... > Version Control > Git` with the URL `https://github.com/cforgaci/mint2324Q3U.git` and project directory name `mint2324Q3U`. Browse to a location of your choice on your computer and click on `Create Project`. This will create a project directory populated with the data scripts used in the workshop.

3.  Open `script.qmd`. This will bring you to the computational notebook from where this document was rendered. Continue reading there.
...
```{r extract-text-from-pdf, message=FALSE, eval=FALSE}
...
cat(keywords, sep = "")
cat("How would you name these topics? Use maximum two words to name the topics and provide a one-sentence description for each.")
...
#     list(
#       "role" = "user",
#       "content" = "I have 5 topics, each described by 10 words. The keywords are as follows:
# - The words for Topic 1 are: nitrogen emissions nature farmers permit government policy province space percent.
# - The words for Topic 2 are: water soil energy level time country groundwater storage start remkes.
# - The words for Topic 3 are: service delivery dutch opinion hours protests share family minister archive.
# - The words for Topic 4 are: nature biodiversity land aerius species restoration carbon natural piece ecological.
# - The words for Topic 5 are: farmers agriculture european agricultural time farmer food farming green week.
...
cat("1. Environmental Policy - Government regulations on nitrogen emissions and space allocation for farmers.\n2. Water Management - Strategies for conserving soil, energy, and groundwater resources over time.\n3. Public Services - Dutch minister's response to protests on service delivery hours.\n4. Biodiversity Conservation - Efforts to restore natural habitats and protect diverse species.\n5. Sustainable Agriculture - European farmers' commitment to green practices for food production.")
```
