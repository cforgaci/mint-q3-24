...
```{r swcustom}
# Add custom words you want to remove from your results inside c("WORD1", "WORD2", "ETC.")
custom_stop_words <- data.frame(word = c("WORD1", "WORD2", "ETC."))  
```
...
> PASTE CHATGPT RESPONSE HERE. EVERY LINE SHOULD BE PRECEDED BY A `>` SIGN, TO SHOW THE RESPONSE AS A QUOTE.
...
# Make sure the number of phrases is equal to k
topic_names <- c("TOPIC 1 NAME",
                 "TOPIC 2 NAME",
                 "TOPIC 3 NAME",
                 "TOPIC 4 NAME",
                 "TOPIC N NAME")
