---
title: "Mining Dutch<br>media about farming communities"
...
1. Tutorial: Finding topics in Dutch news
2. Tutorial: How to get your own data from social media? (Shuyu Zhang)
3. Exercise: Topic modeling with your own data

# Part 1: Finding topics in Dutch news {.center background-color="#00A6D6"}
...
# Go to [edu.nl/ph3a6](edu.nl/ph3a6) {background-color="#00A6D6"}
